package net.lldv.upgradeablefurnaces.components.tools;
...
public class Language {
    ...
    public static void initConfiguration() {
        messages.clear();
        UpgradeableFurnaces.getInstance().saveResource("messages.yml");
        Config m = new Config(UpgradeableFurnaces.getInstance().getDataFolder() + "/messages.yml");
