package net.lldv.upgradeablefurnaces.forms.simple;
...
import net.lldv.upgradeablefurnaces.forms.FormHandler;
...
public class SimpleForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(UpgradeableFurnaces.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
